...
//应用到layout_feed_interaction、layout_feed_top_comment布局
public class InteractionPresenter {
                ...
                .execute(new JsonCallback<JSONObject>() {
                    ...
                    public void onSuccess(ApiResponse<JSONObject> response) {
                        if (response.body != null) {
                            ...
                            //帖子点赞完成之后通过LiveDataBus把feed对象发送出去
    ...
    public static void openShare(Context context, Feed feed) {
        ...
        shareDialog.setShareContent(shareContent);//分享内容
                        ...
                        .execute(new JsonCallback<JSONObject>() {
                            ...
                            public void onSuccess(ApiResponse<JSONObject> response) {
                                if (response.body != null) {
                                    ...
                                    feed.getUgc().setShareCount(count);//刷新界面的分享数量
                                }
                            }
    ...
    //给一个帖子的评论点赞/取消点赞
    //传入LifecycleOwner，如果用户还没登陆需要唤起登录
                ...
                .execute(new JsonCallback<JSONObject>() {
                    ...
                    public void onSuccess(ApiResponse<JSONObject> response) {
                        if (response.body != null) {
                            ...
                            comment.getUgc().setHasLiked(hasLiked);//点赞成功刷新页面
                        }
                    }
